...
if __name__ == "__main__": # will only run if this is the file being directly executed (won't run if imported)

    parser = argparse.ArgumentParser(description='A Discord Bot for UBB')
    parser.add_argument('-t', '--token', help='The token of your Discord bot', required=True)
    ...
    @bot.command()
    async def help(ctx):
        help_embed = discord.Embed(title="**Commands**", color=0x00afff, type="rich",
                                   url="https://github.com/dxf/Alexa",
